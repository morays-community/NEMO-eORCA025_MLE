...
QUEUE=cpu_p1          # queue name (e.g. curie )

# Directory names
#~~~~~~~~~~~~~~~~
# 
WORKDIR=$WORK/WORK/
TMPDIR=$WORK/TMP/TMP_${CONFIG_CASE}
MACHINE=jean-zay
DIRRST=$DDIR/$CONFIG/${CONFIG_CASE}-R/${CONFIG_CASE}-RST
...
ROTE_DIR=/gpfswork/rech/cli/rote001/
CLI_DIR=/gpfswork/rech/cli/rcli002/
...
P_PY_DIR=$WORK/local_libs/morays-NEMO/MLE-Fluxes-CNN/MLE-Fluxes-CNN/INFERENCES
