...
def main(respath,plotpath,confcase,freq,years,depth):
    global to_plot
    global infos
                ...
                if os.path.isfile(grid_file):
                    ...
                    for fld in to_plot[file]:
                        ...
                        if depth == 0:
                            ...
                            output = outpath + '/' + confcase + '_y' + year + '.' + freq + '_' + file + '_' + fld + '_dpt' + str(depth) + '.png'
...
if __name__=="__main__":
    ...
    # proceed
    main(respath,plotpath,confcase,freqs,years,depth)
